...
class SettingsDialog(QDialog):
    ...
    def _tab_images(self):
        ...
        form.addRow(_help(tr("Đổi tên khi tải: <SN>_<YYYY.MM.DD HH.MM.SS>_<Left|Right>_Passed|"
                             "Failed_#<thứ tự đầu>.<ext> (Left=CCD1, Right=CCD2; vd 123456_"
                             "2026.06.09 18.34.15_Left_Passed_#1.jpg; 2 đầu 8X -> _#1, _#2).")))
        return _scroll(w)
